    ...
    <div class="admin-form-container">
        ...
        <form method="post" class="admin-form">
            ...
            <div class="form-group">
                ...
                <small class="form-text text-muted">Laissez vide pour conserver le mot de passe actuel. Le nouveau mot de passe doit contenir au moins 6 caractères.</small>
            </div>
...
<link rel="stylesheet" href="css/actu-create.css">
