        ...
        <form method="post" class="admin-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nom" name="nom" class="form-control" required 
                       value="<?= isset($_POST['nom']) ? htmlspecialchars($_POST['nom']) : htmlspecialchars($patient['nom']) ?>">
            </div>

            <div class="form-group">
                <label for="prenom">Prénom</label>
                <input type="text" id="prenom" name="prenom" class="form-control" required 
                       value="<?= isset($_POST['prenom']) ? htmlspecialchars($_POST['prenom']) : htmlspecialchars($patient['prenom']) ?>">
            </div>

            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" id="email" name="email" class="form-control" required 
                       value="<?= isset($_POST['email']) ? htmlspecialchars($_POST['email']) : htmlspecialchars($patient['email']) ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <div style="display: flex; align-items: center; gap: 6px;">
                    ...
                    <input type="tel" 
                           ...
                           value="<?php
                               $phone = isset($_POST['telephone']) ? $_POST['telephone'] : $patient['telephone'];
            ...
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       autocomplete="off"
                       value="<?php 
                           $date_value = isset($_POST['date_naissance']) ? $_POST['date_naissance'] : $patient['date_naissance'];
            ...
            <div class="form-group">
                ...
                <small class="form-text text-muted">Laissez vide pour conserver le mot de passe actuel. Le nouveau mot de passe doit contenir : au moins 8 caractères, une majuscule, une minuscule, un chiffre et un caractère spécial (!@#$%^&*...).</small>
            </div>
