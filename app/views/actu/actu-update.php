      ...
      <div class="actu-create-field">
        ...
        <?php if (!empty($actu['image'])): ?>
          ...
          <div style="margin-top:0.5em;">
            <img src="<?php echo BASE_URL; ?>/public/uploads/<?php echo htmlspecialchars($actu['image']); ?>" alt="Image actuelle" loading="lazy" style="max-width:180px;max-height:120px;border-radius:8px;box-shadow:0 2px 8px #0001;">
