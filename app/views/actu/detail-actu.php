...
<!-- CSS spécifique au détail d'une actualité -->
<link rel="stylesheet" href="<?php echo BASE_URL; ?>/css/modules/actu/detail-actu.css">
<main>
          ...
          <div class="actu-detail-flex<?php echo empty($actu['image']) ? ' no-image' : ''; ?>">
            <?php if (!empty($actu['image'])): ?>
              ...
              <div class="actu-detail-image">
                <img src="<?php echo BASE_URL; ?>/public/uploads/<?php echo htmlspecialchars($actu['image']); ?>" alt="Image de l'actualité" loading="lazy">
              </div>
            <?php endif; ?>
