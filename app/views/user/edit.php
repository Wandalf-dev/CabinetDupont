                    ...
                    <div style="display: flex; align-items: center; gap: 6px;">
                        ...
                        <input
                            ...
                            value="<?php
                                ...
                                // si commence par 33, on retire
                                if (strpos($digits, '33') === 0) {
                                    $digits = substr($digits, 2);
                                }
                                // si commence par 0, on retire
                                if (strpos($digits, '0') === 0) {
                                    $digits = substr($digits, 1);
                                }
                                // format X-XX-XX-XX-XX si 9 chiffres
                                if (strlen($digits) === 9) {
            ...
            <div class="info-block">
                ...
                <div class="form-group password-group">
                    ...
                    <div class="password-input-container">
                        ...
                        <span class="password-toggle" onclick="togglePassword('current_password', this)" aria-label="Afficher/Masquer le mot de passe">
                ...
                <div class="form-group password-group">
                    ...
                    <div class="password-input-container">
                        ...
                        <span class="password-toggle" onclick="togglePassword('new_password', this)" aria-label="Afficher/Masquer le mot de passe">
                            <i class="fas fa-eye" aria-hidden="true"></i>
                        </span>
                    </div>
                </div>
                ...
                <div class="form-group password-group">
                    ...
                    <div class="password-input-container">
                        ...
                        <span class="password-toggle" onclick="togglePassword('confirm_password', this)" aria-label="Afficher/Masquer le mot de passe">
                            <i class="fas fa-eye" aria-hidden="true"></i>
                        </span>
                    </div>
                </div>
...
flatpickr(".flatpickr", {
    ...
    // defaultDate retiré : on garde la valeur du champ (date réelle du profil)
});
